...
<svg className="car" viewBox="0 0 102 40" xmlns="http://www.w3.org/2000/svg">
	<g transform="translate(2 1)" stroke="#ef4444" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
		...
		<ellipse className="car__wheel--left" strokeWidth="3.2" fill="#09090b" cx="83.493" cy="30.25" rx="6.922" ry="6.808"/>
		<ellipse className="car__wheel--right" strokeWidth="3.2" fill="#09090b" cx="46.511" cy="30.25" rx="6.922" ry="6.808"/>
